<template>
      ...
      <div class="relative" @click.outside="open = false">
        ...
        <transition name="fade">
          <div v-if="open" class="absolute right-0 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg z-50 border">
            <div class="px-4 py-2 font-semibold border-b">Saiful Islam</div>
            <ul class="text-sm">
              <li>
  ...
  <!-- Main Content -->
  <main class="pt-[130px] container mx-auto px-4 pb-20">
...
const logout = () => {
  alert('Logout logic here') // Replace this with your actual logout logic
}
