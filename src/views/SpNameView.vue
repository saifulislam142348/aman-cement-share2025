...
async function fetchDivisionMonthlyBarData(division) {
  try {
    const res = await fetch('https://market.bditfirm.com/api/market/monthly-sp-name', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function fetchCompanyMonthlyBarData(company_name) {
  try {
    const res = await fetch('https://market.bditfirm.com/api/market/company-monthly-sp-name', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function fetchZoneTreeData(company_name, month, year) {
  try {
    const res = await fetch('https://market.bditfirm.com/api/market/zone-wise-sp-name', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function fetchRegionTreeData(division, month, year) {
  try {
    const res = await fetch('https://market.bditfirm.com/api/market/region-wise-sp-name', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
