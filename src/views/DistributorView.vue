...
async function fetchData() {
  try {
    // axios handles query parameters automatically via { params }
    const { data } = await api.get('market/distributor', {
    ...
    console.error('Distributor fetch error:', e.response?.data || e.message || e)
  }
}
watchEffect(() => {
